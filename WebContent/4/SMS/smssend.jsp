    ...
    if(action.equals("go")) {
        ...
        String user_id = base64Encode("wnsgus3233"); // SMS아이디
        String secure = base64Encode("f67f9d70ce62ade26be1ff1b532aaa8e");//인증키
        ...
        // 데이터 맵핑 변수 정의
        String arrKey[]
            = new String[] {"user_id","secure","msg", "rphone","sphone1","sphone2","sphone3","mode","testflag", "smsType", "subject"};
